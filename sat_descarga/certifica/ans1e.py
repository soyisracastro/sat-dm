"""
Codificador ASN.1/DER minimalista (solo escritura).

Portado de `satcfdi.ans1e` (SAT-CFDI/python-satcfdi, licencia MIT). Se usa para
construir a mano el PKCS#10 y el PKCS#7/CMS de las solicitudes de e.firma y CSD,
igual que hace la app oficial "Certifica" del SAT. No depende de nada fuera de la
librería estándar.

Se mantiene la API original (`Ans1Encoder`, `Numbers`, `Classes`, `to_utc_time`)
para que el resto del port sea una traducción directa del código de satcfdi.
"""
